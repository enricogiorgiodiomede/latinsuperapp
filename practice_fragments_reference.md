# Practice fragments - reference sheet

Working record of the passages selected for the practice fragment bank (`js/fragments.js`):
where each came from, line numbers, and notes. Used to pick passages and to expand later.
Latin from official sources (The Latin Library for complete texts; Attalus / PHI / standard
fragment editions for the fragmentary authors). Translations in the bank are original.

Difficulty is varied on purpose within each text (some passages harder than others).
...
- **Book IV (part 1 DONE, v1.14.5: 353-363, 436-446, 469-477, 823-842, 962-986; v. 823 emended, see the CHANGELOG)**: 353-363 · 436-446 · 469-477 · 823-842 · 962-986 · ★1058-1076 · ★1121-1140 (love as a pathology; **cross-ref Tusculanae Disputationes IV.68-69 both ways**) · 1149-1170 · 1192-1208 · 1278-1287
...
### Aulularia (`aulularia`) - spread across acts; verbatim verified from TLL; proofread against TLL/Splash
- **Act I, Sc. 1, vv. 40-51** - Euclio drives out the slave Staphyla ("oculis emissiciis"). Medium; colloquial abuse. (Proofread fix: v.48 `in manu` -> `in manum`.)
...
- **Act I, Sc. 1, vv. 22-34** - Diniarchus's love-as-bankruptcy overture (*summa summarum*) + the *merces annua*/*bolus* ledger. HARD. [extended v71; added vv.31-34 incl. the ~ crux at v.33 -> user-proofread OK, confirmed]
- **Act II, Sc. 2, vv. 256-268** - Truculentus berating Astaphium (*arietat*; salve/salute/sanior pun) + the *truncum lentum* name-pun. Medium. [extended v71; added vv.264-268 -> user-proofread OK, confirmed]
...
- **Pomponius & Novius** (`pomponius-bononiensis-and-quintus-novius`):
  - Pomponius (3): Fullones (existing, PHI/Ribbeck) + **Galli Transalpini** "Mars, tibi voveo facturum, si unquam rediero, bidente verre" (Macrobius Sat. VI.9) + **Kalendae Martiae** "Vocem deducas oportet, ut mulieris videantur" (Macrobius Sat. VI.4 - a man told to fake a woman's voice; the play is named for the Matronalia). Both Macrobius fragments via LacusCurtius `penelope.uchicago.edu/Thayer/L/Roman/Texts/Macrobius/Saturnalia/6*.html`.
...
## Gaius Lucilius (`gaius-lucilius`, `saturae`) - DONE, now 8 fragments [v1.1.3-1.1.4, 2026-07-07]
Not needsSelection (single `Saturae` work, cycles). Lucilius survives only in quotation across several editions (Marx / Warmington ROL III / Terzaghi-Mariotti / Krenkel). Sourcing: Cicero + Pliny on TLL; the rest from Warmington ROL III full-text OCR on archive.org (`L329RemainsOfOldLatinIIILuciliusTheTwelveTables`). **All new Latin flagged for proofread** (esp. the reassembled Book-1 and Book-15 fragments; edition line-numbers vary). Order in the bank: manifesto, poetic-pride, Lupus, voyage, Albucius, myth, rat-race, then the existing virtus.
- **Manifesto** (Book 26, trochaic septenarii): verbatim = "Manium Persium haec legere nolo, Iunium Congum volo" (Pliny *NH* praef. 7; TLL prints "Congium", standard = "Congum"). Cicero variant "Persium non curo legere... Laelium Decumum volo" (*De Or.* II.25) and the Scipio/Tarentines-Consentini-Siculi point (*De Fin.* I.7) are Cicero's paraphrase - kept in the analysis, not the translatable Latin. **No "Cosconius" exists in the sources** (user misremembered "Laelium Decumum").
- **Poetic pride** (Book 26, trochaic septenarii; **v1.1.4, user-supplied**): "publicanus vero ut Asiae fiam, ut scripturarius, / pro Lucilio, id ego nolo, et uno hoc non muto omnia" (Nonius 351,6 = Warmington 650-1 = vv.627-8 T-M). Refuses to trade being Lucilius the poet for a tax-farmer's riches. Placed 2nd, pairs with the manifesto (both Book 26 programmatic).
- **Concilium Deorum / Lupus** (Book 1, hexameter): reassembled scattered lines, ordered by SENSE not verse-number: council "Consilium summis hominum de rebus habebant" (Servius ad Aen. IX.227) + "quo populum atque urbem pacto servare potisset amplius Romanam" + luxury "praetextae ac tunicae Lydorum opus sordidulum omne / psilae atque amphitapi villis ingentibus molles" (Nonius) + **[v1.1.4, user-supplied]** the gods on Lupus's face "quae facies, qui vultus viro? / vultus item ut facies, mors cetera, morbus, venenum" (vv.43-44) + the dinner-plot "ad cenam adducam, et primum hisce abdomina tunni / advenientibus priva dabo cephalaeaque acarnae" (vv.49-50) + death punchline "Occidunt, Lupe, saperdae te et iura siluri!" (Varro L.L. VI.47; pun on lupus the sea-bass). Model for Seneca's *Apocolocyntosis*. **PROOFREAD FIX (user):** `amphitapi` -> `amphitapae` (must agree with fem. pl. psilae/molles; amphitapa neuter would need psila/mollia; amphitapae is also the commonest source reading, vs amphitapoe). Standalone `...` line before the `praetextae` line (not leading `...praetextae`).
- **Iter Siculum voyage** (Book 3, hexameter): "Praeterea omne iter est hoc labosum atque lutosum" (Nonius) + "Mantica cantheri costas gravitate premebat" (Porphyrio; cf. Hor. Sat. I.6.106) + susque deque "verum haec ludus ibi... / illud opus durum, ut Setinum accessimus finem, / αἰγίλιποι montes, Aetnae omnes, asperi Athones" (Gellius XVI.9, KEEP the Greek word) + **[v1.1.4, user-supplied]** the food complaint "ostrea nulla fuit, non purpura, nulla peloris / asparagi nulli" (vv.127-8) + "nam mel regionibus illis / incrustatus calix rutai caulis habetur" + "exhalas tum acidos ex pectore ructus" (Charisius/Nonius, frr.127-130) + arrival "optasti, freta, Messanam, Regina videbis / moenia, tum Liparas, Facelinae templa Dianae" (Probus). **PROOFREAD FIXES (user):** reordered to the standard edition sequence (arrival/propempticon FIRST, then mantica + susque block adjacent, then road, then food, then belches); `susque et deque` (not `susque haec deque`); analysis got a side-note on the Greek αἰγίλιποι (macaronic Greek-in-Latin; cf. Horace Sat. I.10). Ellipsis style = standalone `...` lines for skipped verses. **First Roman travel-satire, model for Horace Sat. I.5** (noted in the analysis). **Capo Colonna / Cape Lacinium does NOT appear in any surviving fragment** - the route runs to the Sicilian strait (Messana/Rhegium); told user.
- **Albucius** (Cic. *De Fin.* I.9, hexameter, 7 lines verbatim on TLL): "Graecum te, Albuci... maluisti dici... 'chaere,' inquam, 'Tite!'... hinc hostis mi Albucius, hinc inimicus." Scaevola mock-greets the philhellene in Greek. (User cited vv.78-84 T-M; Warmington puts it Book 3.)
...
were rewritten in v1.14.3.** **In Catilinam I (10) was done in v1.14.5** - each note kept its rhetorical analysis and gained a
paragraph of history or aftermath and a paragraph of grammar, which is the pattern for the rest. **58 Cicero notes
remain**, a work at a time: In Catilinam II, III, IV (21), Pro Archia + Pro Milone (16), then Verrines + Philippics +
Pro Caelio + In Pisonem (21 minus what is done), plus Ad Atticum I.16 and De Amicitia 20. **Catullus and Sallust are excluded on the user's instruction** - their
...
- **Pro Caelio** (`pro-caelio`) - 56 BC, delivered during the Ludi Megalenses. **8 fragments**; +5 in
  ...
  - **12 (v1.7.3)** Catiline: *permulta maximarum non expressa signa, sed adumbrata [lineamenta]
    ...
    **Cross-ref: In Catilinam I-IV, 32 excerpts.** **EXTENDED to the end of the
    ...
    new `emend` field, **the only emended word in the whole bank**, and both analyses explain it.
...
(deliberately tested: it printed `FAIL ... stale emendation` and `1 mismatched`). Successes print as
...
**eight in v1.13.1** (five in the nine new excerpts, three more in the lengthened launch-era notes).
The shapes that keep producing it are a bolded sentence that quotes a Latin term (`**...his own
*dignitas***`, `**That is Roman *virtus* stated as...**`) and a bolded sentence that names a work
(`**the thesis of the entire *Bellum Civile***`). **Restructure, do not merely unbold** - move the
bold to the clause that does not carry the Latin. `lint_markdown.js` catches every one, so run it
before the release paperwork, not after.
...
**v1.13.1 added four more markers and two more carrying excerpts.** (5) **the mechanism stated instead of shown** - *quam quisque poterat maxime insignis, quo notior testatiorque virtus esset eius* (VIII.42): Caesar shows *virtus* happening (the centurions of BG II.25, Pullo and Vorenus at V.44, Scaeva's shield at BC III.53) and lets you infer why; Hirtius writes the why down. (6) **the arithmetic given in the same sentence as the fact** - *neque obscure duae legiones uni detrahuntur* (VIII.54), where Caesar would narrate the decree and let you notice. (7) **reported gossip** - *insolenter adversarii sui gloriarentur* (VIII.50), a whole period subordinated to what the other side was boasting, which Caesar never does about Roman politics. (8) **the calculation placed before the act** again at VIII.24 (*proximum suae dignitatis esse ducebat*), the same shape as VIII.44. **Left alone deliberately at VIII.34, VIII.43 and VIII.49**, where the writing is indistinguishable from Caesar's and saying so would be padding.

**SOURCE FAULTS IN `gall8`:** **VIII.44 prints `Lacterius`** for `Lucterius`, whom the same book spells correctly seven times - and the first draft of the English had silently corrected it, which is exactly the thing an emendation exists to prevent. **The book ends with NO FULL STOP**, on the single word `Contendit`; supplied and declared, as at `BC III.53`. **VIII.19 prints `eum interim nulla calamitate victus Correus`** for `cum interim`, which leaves the sentence with no construction at all - `Correus` is nominative and `eum` governs nothing; emended, and it is also exactly where Perseus cuts section 8. **BOOK VIII NEEDED NO `overrides` AT ALL** - the Latin Library and Perseus agree throughout, against seven overrides for BC Book I.
...
**A CANDIDATE EXCERPT, parked here so it is not lost:** **Cicero, *De Divinatione* I.90**, on **Diviciacus the Aeduan** - Caesar's closest Gallic ally, whom Cicero met in Rome and describes as a druid claiming knowledge of natural philosophy and the power to predict the future. It is the only place in ancient literature where a *named* druid is described by someone who had met him, and it would pair with `(De Bello Gallico VI.13)` and `(VI.14)`. **It is NOT currently in the app** - VI.14's analysis briefly claimed it was, and that claim was withdrawn in the v1.11.4 follow-up. Add it if *De Divinatione* is ever extended past its three.

**ITALIAN: a final clause is `affinche`, and `apparire` takes `di` before an infinitive.** The v1.11.4 follow-up fixed *perche apparisse aver usato misericordia* to ***affinche apparisse di aver usato misericordia*** in II.27-28's translation and in the three analyses quoting it (II.27-28, III.16, IV.14-15), and the identical fault in `(In Catilinam IV.19)`. `perche` alone is ambiguous between final and causal; prefer `affinche` when the Latin has `ut` + subjunctive of purpose.
