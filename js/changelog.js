  ...
  var VERSIONS = [
    {
      ...
      en: {
        ...
        changed: [
          ...
          'These twelve carry the chapter number but NOT the bold subsection numbers, and that is deliberate. No edition that can be reached divides this work: Perseus does not publish it at all, the database that does is now behind a bot check, and the one site with the full Latin numbers chapters only. Rather than invent the boundaries, the app leaves them out until a real edition can be consulted.'
        ],
        deleted: [
          'Nothing was deleted.'
        ]
      ...
      it: {
        ...
        changed: [
          ...
          'Questi dodici portano il numero di capitolo ma NON i numeri di paragrafo in grassetto, ed è una scelta. Nessuna edizione raggiungibile divide quest\'opera: Perseo non la pubblica affatto, la banca dati che lo fa è ora dietro un controllo antirobot, e l\'unico sito con il latino completo numera solo i capitoli. Piuttosto che inventare i confini, l\'app li lascia fuori finché non si potrà consultare un\'edizione vera.'
        ],
        deleted: [
