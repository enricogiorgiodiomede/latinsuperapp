 ...
 * holds fragments with { title, citation, description, latin, italian, english,
 * analysis }. needsSelection:true authors (Plautus, Terence, Caecilius) route
 * through practice-select.html first so the reader picks a comedy/text.
 *
