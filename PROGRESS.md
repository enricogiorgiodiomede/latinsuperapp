...
- **NEXT: the plan is written out release by release in
  ...
  **v1.9.0** = De Officiis 5 + De Re Publica 4 + Somnium Scipionis 4; v1.9.1 = Tusculanae 5;
  ...
  at 23 across 5**). Then **Caesar, Hirtius, Lucretius, Sallust, Catullus**. **v1.8.3 through v1.9.4 are shipped and the PHILOSOPHICAL GROUP IS CLOSED (48 across 10 works)**,
  so the next one up is **v1.10.0, which takes the rhetorical group live** (De Oratore 5 + Brutus 3
  + Orator 3). The one philosophical question still open is whether the Tusculans grow past 5, in
