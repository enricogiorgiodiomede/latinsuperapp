...
- **NEXT: the plan is written out release by release in
  ...
  **v1.9.0** = De Officiis 5 + De Re Publica 4 + Somnium Scipionis 4; v1.9.1 = Tusculanae 5;
  ...
  at 23 across 5**). Then **Caesar, Hirtius, Lucretius, Sallust, Catullus**. **v1.8.3 through v1.10.0 are shipped: the PHILOSOPHICAL GROUP IS CLOSED (48 across 10 works)
  and the RHETORICAL GROUP IS LIVE (11 across 3)**, so the next one up is **v1.10.1**
  (De Optimo Genere 3 + Topica 2), then v1.10.2 takes the big three to 8/5/5 and finishes
  rhetorical at 23 across 5. The one philosophical question still open is whether the Tusculans grow past 5, in
