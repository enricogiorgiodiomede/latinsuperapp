...
| **Gaius Julius Caesar** *(needsSelection, NESTED chooser, v1.11.0)* | Good Exercise | **Two groups, ten book-works**: `bellum-gallicum` = `bg-i`..`bg-vii`, `bellum-civile` = `bc-i`..`bc-iii`, all mapped in sources.json. Filled so far: **Book I 6** (1, 13, 29, 39, 40.10-15, 53) · **Book II 4** (1, 20-21, 25, 27-28) · **Book VI 2** (13, 14) · **BC I 1** (7) = **13**. Empty books are hidden by `PracticeBank.works()` until filled. |
