...
2. **Cache-busting**: every JS/CSS include in the 4 HTML files carries `?v=N`. **Bump N**
   ...
   whenever you change a JS/CSS file. **Currently `v=80`.**
...
| **Marcus Tullius Cicero** *(needsSelection, NESTED chooser)* | Very Difficult | **Speeches (43, v1.5.0-v1.6.4), works ALPHABETICAL**: **In Catilinam I 10 · II 7 · III 7 · IV 7 = 31, CATILINARIANS COMPLETE** · In Verrem 3 · Philippica II 3 · Pro Archia 3 · Pro Milone 3. **Letters**: Ad Atticum 1. **Philosophical works**: De Amicitia 1. (45 total) |
...
Current: **v1.6.4, cache ?v=80**, pushed. Archaic is complete (Plautus 10 comedies / 50 frags since v1.4.0).
