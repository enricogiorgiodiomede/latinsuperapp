...
- **NEXT: the plan is written out release by release in
  ...
  **v1.9.0** = De Officiis 5 + De Re Publica 4 + Somnium Scipionis 4; v1.9.1 = Tusculanae 5;
  ...
  at 23 across 5**). Then **Caesar, Hirtius, Lucretius, Sallust, Catullus**. **v1.8.3 through v1.10.1 are shipped: the PHILOSOPHICAL GROUP IS CLOSED (48 across 10 works)
  and ALL FIVE RHETORICAL WORKS ARE LIVE (16 across 5)**, so the next one up is **v1.10.2**,
  which takes De Oratore 5 -> 8, Brutus 3 -> 5 and Orator 3 -> 5 and **finishes Cicero** at
  rhetorical 23 across 5. Top-up candidates are listed at the end of the v1.10.0 block in
  `practice_fragments_reference.md`. The one philosophical question still open is whether the Tusculans grow past 5, in
