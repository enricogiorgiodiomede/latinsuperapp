...
| **Gaius Julius Caesar** *(needsSelection, NESTED chooser, v1.11.0)* | Good Exercise | **Two groups, ten book-works**: `bellum-gallicum` = `bg-i`..`bg-vii`, `bellum-civile` = `bc-i`..`bc-iii`, all mapped in sources.json. Filled so far: BG VI.13 · VI.14 · BC I.7 (3). Empty books are hidden by `PracticeBank.works()` until filled. |
