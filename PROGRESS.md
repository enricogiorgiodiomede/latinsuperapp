...
- **NEXT: the plan is written out release by release in
  ...
  **v1.9.0** = De Officiis 5 + De Re Publica 4 + Somnium Scipionis 4; v1.9.1 = Tusculanae 5;
  ...
  at 23 across 5**). Then **Caesar, Hirtius, Lucretius, Sallust, Catullus**. **THE WHOLE PLAN IS SHIPPED. CICERO IS COMPLETE** - 213 across 38 works, Speeches 116,
  Letters 26, Philosophical 48 (closed), Rhetorical 23 (closed). **The next thing in this app is
