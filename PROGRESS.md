...
| **Marcus Tullius Cicero** *(needsSelection, NESTED chooser)* | Very Difficult | **Speeches (116 across 19 works, v1.5.0-v1.7.7), CHRONOLOGICAL**: **THE VERRINES ARE CLOSED AT 25 (5x5), 7 works: Divinatio 3 · Actio Prima 3 (cited BY CHAPTER) · II.1 3 · II.2 3 · II.3 3 · II.4 De signis 5 · II.5 De suppliciis 5** · **In Catilinam I 10 · II 7 · III 7 · IV 8 = 32** · Pro Archia 8 · **Pro Caelio 8** · **In Pisonem 8** · Pro Milone 8 · **Philippica I 7 · II 8 · IV 5 · XIV 7 = 27 (THE PHILIPPICS ARE FINISHED)**. **Letters (26 across 4 works, v1.8.0-v1.8.2)**: Ad Atticum 8 · Ad Familiares 8 · Ad Quintum 5 · Ad Brutum 5, all cited BY BOOK AND LETTER. **PHILOSOPHICAL FINISHED: 48 across 10 works, v1.8.3-v1.9.4**: De Re Publica 5 · Somnium Scipionis 5 · Paradoxa Stoicorum 3 · Tusculanae 5 · De Natura Deorum 3 · De Divinatione 3 · **De Fato 3** · De Senectute 8 · De Amicitia 8 · De Officiis 5, in PHIL_ORDER (chronological). **RHETORICAL FINISHED: 26 across 5 works, v1.10.0-v1.10.3**: De Oratore 8 · Brutus 5 · Orator 5 · De Optimo Genere Oratorum 3 · **Topica 5**, in RHET_ORDER. **CICERO IS COMPLETE at 216 across 38 works** - well over a third of the whole bank, and closed for a good while by the user's decision. (216 total across 38 works) |
| **Gaius Julius Caesar** *(needsSelection, NESTED chooser, v1.11.0)* | Good Exercise | **Two groups, ten book-works**: `bellum-gallicum` = `bg-i`..`bg-vii`, `bellum-civile` = `bc-i`..`bc-iii`, all mapped in sources.json. Filled so far: **Book I 6** (1, 13, 29, 39, 40.10-15, 53) · **Book II 4** (1, 20-21, 25, 27-28) · **Book III 3** (13, 14, 16) · **Book IV 5** (5, 14-15, 17, 25, 33) · **Book V 7** (7, 14, 27, 30, 37, 44, 48) · **Book VI 6** (11, 13, 14, 16, 21, 28) · **Book VII 9** (3, 4, 14, 15, 28, 52, 73, 77.12-16, 89) · **BC I 1** (7) = **41**. **THE GALLIC WAR IS COMPLETE at its allocated 40**, all seven books closed; what remains of the campaign is the Civil War (29 new) and Hirtius (42 new). Empty books are hidden by `PracticeBank.works()` until filled. |
| **Aulus Hirtius** *(needsSelection, flat chooser, v1.11.0)* | Manageable | **Two works**: `bellum-gallicum-viii` (BG VIII praef.) · `bellum-alexandrinum` (1, 2). Work ids deliberately distinct from Caesar's - sources.json is keyed by work id and shared across authors. (3) |
...
**Cicero's Speeches: 116 fragments across 19 works, in chronological order of delivery** -
**the Verrines, 7 works and CLOSED at 25 fragments (5x5)** (Divinatio 3, Actio Prima 3, II.1 3,
II.2 3, II.3 3, II.4 De signis 5, II.5 De suppliciis 5) · In Catilinam I 10, II 7, III 7, IV 8 (**the Catilinarians are finished, 32**) ·
...
- ~~**v1.7.0**~~ DONE 23/08: **Pro Caelio** (3) + **In Pisonem** (3) + **Philippics I, IV, XIV** (3 each) = +15.
  Sources confirmed live: `cicero/cael.shtml`, `cicero/piso.shtml`, `phil1/phil4/phil14.shtml`.
**Roadmap shifted by one on 2026-08-24 at the user's instruction**, because deepening all four
Philippics is +15 and was split into two releases rather than shipped as one.
- ~~**v1.7.1**~~ DONE 24/08: **Philippica I 3 -> 7** (7, 11-12, 18, 26) + **Philippica IV 3 -> 5** (5, 12) = +6,
  plus a clause-by-clause translation-accuracy pass over all 12 fragments of those two speeches.
- ~~**v1.7.2**~~ DONE 24/08: **Philippica II 3 -> 8** (28-29, **44**, 67, 85-86, 104) + **Philippica XIV
  3 -> 7** (6, 10, 23, 27) = **+9**, with the translation-accuracy pass over all 15 fragments of those
  two speeches. **II.44 restored at the user's explicit instruction (2026-08-24)**, reversing the
...
- ~~**v1.7.7**~~ DONE 26/08: **the Verrines closed at 25 (5x5)** (+7) - the five thinner parts to 3
  each: Divinatio 19-20, Actio Prima ch. XI, II.1 46-47, II.2 86 and 192, II.3 120 and 207. **The
  user's call: no part should be left with only one or two.** Third `emend` (a stray full stop at
  II.1.46, confirmed on Poesia Latina), which slightly **widens the emendation policy to plain errors
...
- **v1.8.0 FOLLOW-UP (27/08, no version bump - the v1.7.3 precedent):** **POLICY CHANGED, the user's
  call - MEND THE SOURCE, DO NOT TRIM PAST IT.** Att. I.18 (+3 emendations, now the whole letter opening
...
- ~~**v1.8.2**~~ DONE 28/08: **THE LETTERS ARE FINISHED, +5.** The user chose **8** for both:
  Ad Atticum 5 -> 8 (IV.1 the return from exile, VII.7 *quos tu bonos esse dicas*, XII.14 the lost
...
- ~~**v1.8.4**~~ DONE 29/08: **De Senectute, new work, +5** (17 the helmsman, 32-33 Milo's ox and
  ...
  **2 works / 10**, Cicero **152**, bank **312**. **The speaker is Cato the Elder, who is an app author**,
  ...
  words.
- ~~**v1.9.0**~~ DONE 29/08: **THE PHILOSOPHICAL GROUP IS LIVE, +13** - De Officiis 5 (I.22, I.77,
  I.85, III.38-39 Gyges, III.99 Regulus), De Re Publica 4 (I.39 the definition, I.45 the mixed
  constitution, I.68 liberty into tyranny, II.1-2 not one man's genius), **Somnium Scipionis 4 as its
  own work** (VI.13, VI.16 *quasi punctum*, VI.18-19 the spheres, VI.26 *deum te igitur scito esse*),
  cited `De Re Publica VI.n`. Philosophical **5 works / 23**, Cicero **165**, bank **325**.
...
- **v1.9.0 FOLLOW-UP (29/08, no version bump): A TRANSLATION MUST COVER EXACTLY THE LATIN, NO MORE.**
  ...
  **Run it as part of every release.** It flags 3 of 293, all documented in its header as known-good
  ...
  Somnium VI.16.
- ~~**v1.9.1**~~ DONE 30/08: **Tusculanae Disputationes, new work, +5** (I.74 the discharge argument
  and *commentatio mortis*, II.41 the gladiators, III.24 *est igitur causa omnis in opinione*,
  V.61-62 **the origin of the sword of Damocles**, V.64-66 Archimedes' tomb). Philosophical
  **6 works / 28**, Cicero **170**, bank **330**. **THE FIVE BOOKS ARE MARKED THREE DIFFERENT WAYS**:
...
- ~~**v1.9.3**~~ DONE 30/08: **THE PHILOSOPHICAL GROUP IS FINISHED, +8** - Paradoxa Stoicorum 2 (new work: 1-3 the preface to Brutus with *nihil est tam incredibile, quod non dicendo fiat probabile*; 34 *Quid est enim libertas? Potestas vivendi, ut velis*), De Amicitia 5 -> 8 (44 the first law, ten jussives in a row; 88 Archytas and nobody to tell, the **Somnium run backwards**; 89 the Terence quote and *aliter cum tyranno, aliter cum amico*), De Senectute 5 -> 8 (15 the four charges = the **map of the dialogue**, one app excerpt per block; 39-41 Archytas against pleasure, **oratio obliqua throughout**; 62-63 *miseram esse senectutem quae se oratione defenderet* + the seven passive infinitives of Roman deference). Philosophical **9 works / 42**, Cicero **184 across 32 works**, bank **344**. **THREE MARKER STYLES, ONE TRAP**: `paradoxa`/`amic` print `[n]` and span freely; `senectute` prints a bare arabic number **with a period** (`40. `), which `normalise()` DOES strip, so it spans too - but the style must be rewritten with a `fix` pair; its **roman chapter numerals (`VI.`, `XVIII.`) are NOT strippable**, so no senectute fragment may cross one. **`apply_batch.js`: `fix` now takes one pair OR an array of pairs** (Sen. 39-41 needed two). **Mojibake avoided by choice of passage**: `paradoxa` cannot set Greek (*parãdoja* in §4, *ploÊsiow* in §41), so the preface stops at the end of §3. Kept and flagged: *volt*, *volgus*, *inmortalibus*, *ecfrenate*, *inlecebris*. No emendations. Accuracy pass over all 18 fragments of the two touched works found one thing: "Milo of Croton" in the Sen. 32 translation is not in the Latin, and moved to the analysis.
- ~~**v1.9.4**~~ DONE 30/08: **the philosophical group is CLOSED, +6** - **De Fato 3 (new work)** (10-11 Zopyrus telling Socrates he is stupid while Alcibiades laughs, ending on *non est id positum in naturalibus causis, sed in voluntate, studio, disciplina*; 28-30 the *ignava ratio* and Chrysippus' *confatalia*, **carrying the MACHIAVELLI cross-reference the user asked for** to *Principe* XXV; 42-43 **the cylinder** and *volubilitas*), De Re Publica 4 -> 5 (II.5-7 Romulus siting Rome away from the sea, *inportantur non merces solum adventiciae sed etiam mores*), Somnium 4 -> 5 (VI.15 *nec iniussu eius ... migrandum est*, the direct pair to **Tusc. I.74**), Paradoxa 2 -> 3 (42-43 *Animus oportet tuus se iudicet divitem*). Philosophical **10 works / 48**, Cicero **190 across 33 works**, bank **350**. **`fato` has NO non-ASCII at all** - it transliterates its Greek - so no mojibake to route around; markers are `[n]`. **De Re Publica III.33 (the natural law) and V.1 (Ennius' *moribus antiquis*) are NOT on TLL at all**: the page prints only the palimpsest, so everything quoted by Lactantius and Augustine is missing, which is why the fifth excerpt is from book II. Kept and flagged: *quoi*, *inprimet*, and the source's unclosed dash at *-obstructas*. No emendations. **De Fato added to the author-page bibliography**, mirrored in Italian and regenerated.
- **v1.9.4 also fixed a silent staleness: `js/content.js` was 2759 characters behind `caesar_era_draft.md`.** Over http the app fetches the era drafts live and `js/content.js` is only the `file://` fallback, so it never shows up in browser testing; it had missed the v1.8.3 four-way split of Cicero's Main Works. `__ARCHAIC_MD__` was still byte-identical, `__CAESAR_MD__` was not. **NEW `build_content.js`** regenerates it, mirroring the existing `build_content_it.js`; **run it after editing any `*_era_draft.md`.**
- ~~**v1.10.0**~~ DONE 31/08: **THE RHETORICAL GROUP GOES LIVE, +11** - De Oratore 5 (I.32-33 speech as the human differentia and *leges, iudicia, iura*; I.150 *stilus optimus ... magister*; II.35-36 ***historia ... magistra vitae*, WHICH IS A QUESTION, not a statement**, and is about oratory not history; II.236 the ancient theory of laughter, *turpitudinem aliquam non turpiter*; III.213 *actio ... una dominatur* and the Aeschines anecdote), Brutus 3 (65 *Catonem vero quis ... legit?* with the count of 150+ lost speeches; 262 the verdict on **Caesar's** commentarii, *nudi enim sunt, recti et venusti*; 316 Molon of Rhodes and *prope mutatus*), Orator 3 (69 *ut probet, ut delectet, ut flectat*; 100-101 *Nemo is, inquies, umquam fuit. Ne fuerit.*; 120 *nescire ... semper esse puerum*). Rhetorical **11 across 3 works**, Cicero **201 across 36 works**, bank **361**. **ALL FIVE RHETORICAL PAGES ARE PURE ASCII** - no mojibake. **`oratore1`-`3` bracket BOTH numerals (`[LVI] [213]`), so spans are free; `brut` brackets its arabic sections; BUT `orator` does NOT bracket its roman chapter numerals (`XXI.`, `XXIX.`), which are unstrippable** - or.69 and or.100 both start immediately after one and no Orator fragment may cross a chapter break. **Two emendations, both declared**: *Vt* -> *Ut* (I.33) and *deformitate - quadam continetur* -> *deformitate quadam continetur* (II.236), a stray dash between a noun and its adjective. **`sources.json` key `brutus` is shared with Hortensius**, whose one fragment is Brutus §6; verify.js prints a NOTE and the new Cicero fragments (65, 262, 316) do not overlap it.
- ~~**v1.10.1**~~ DONE 31/08: **the rhetorical group is complete as a set of five, +5** - De Optimo Genere Oratorum 3 (1-2 the anti-Atticist opening, kinds vs degrees, **naming Ennius, Pacuvius and Caecilius**, all app authors; 5 the three *officia* and *memoria est quasi fundamentum, lumen actio*; 13-14 ***non verbum pro verbo*** and *adnumerare* vs *appendere*, **the paragraph Jerome answers in Ep. 57**), Topica 2 (1-5 Trebatius and *memoria repetita in ipsa navigatione conscripsi*, trimmed; 7-8 *locum esse argumenti sedem* and *rationem quae rei dubiae faciat fidem*). Rhetorical **16 across 5 works**, Cicero **206 across 38 works**, bank **366**. **`lint_translations.js` CAUGHT A REAL FAULT BEFORE RELEASE, its third**: Topica 7-8's translations rendered an opening sentence the Latin extract did not contain (EN 1.61, IT 1.64 against a 1.07-1.36 band). **The Latin was extended to cover it rather than the sentence dropped**, and js/fragments.js was reverted to HEAD and the batch rebuilt from scratch rather than patched. **`optgen` is pure ASCII; `topica` IS NOT** - every Greek term on that page is mangled - so both Topica excerpts sit in the clean stretches (1-5 up to the first bad byte inside 6, then 7-8). **First use of `fix` to delete a bracketed roman chapter numeral** (`[V]`) sitting mid-fragment, so the app shows only its own markers. No emendations.
- ~~**v1.10.2**~~ DONE 31/08: **THE RHETORICAL GROUP IS FINISHED AND SO IS CICERO, +7** - De Oratore 5 -> 8 (I.19-20 *nemo poterit esse omni laude cumulatus orator ... nisi omnium rerum ... scientiam consecutus* and *ex rerum cognitione efflorescat et redundet oportet oratio*; II.62-63 **the laws of history**, *ne quid falsi dicere audeat ... ne quid veri non audeat*, pairing with II.35-36; III.155-156 metaphor as *inopia* turned to *delectatio*, and *etiam rustici dicunt*), Brutus 3 -> 5 (1-2 the news of **Hortensius'** death at Rhodes, and *socium potius et consortem gloriosi laboris*; 330 *orbae eloquentiae quasi tutores relicti sumus* and *in hanc rei publicae noctem incidisse* - **the app now has both ends of the book**), Orator 3 -> 5 (8-9 **Phidias** and the *species pulchritudinis*, the passage 100-101 refers back to; 213-214 *me stante*, the crowd erupting at a dichoreus). Rhetorical **23 across 5 works**, **Cicero 213 across 38 works**, bank **373**. **Second use of `fix` to delete a bracketed chapter numeral** (`[VI]` at I.20). **Orator 213-214 stops at *Quaero nonne id numerus effecerit?*** because TLL misplaces the closing quotation mark in the next sentence; the rest is quoted in the analysis instead. No emendations, no mojibake - all three pages pure ASCII.
- ~~**v1.10.3**~~ DONE 01/09: **Topica 2 -> 5, and CICERO IS DONE, +3** - the user's call that De Optimo Genere stays at 3 (a genuinely short pamphlet) while the Topica, a hundred sections long, can carry five. **26-27** what a definition is, and things that *are* (touchable: *fundum aedes, parietem stillicidium...*) against things *quarum nullum subest corpus* (*usus capio, tutela, gens, agnatio*), ending on ***quam notionem voco***; **73** the *artis expers* proofs and the anatomy of *auctoritas*, ***non recte fortasse, sed vulgi opinio mutari vix potest***; **100** the last paragraph of the book, *rutis caesis receptis* and *mancipio dare*, conveyancing terms aimed at Trebatius. Rhetorical **26 across 5**, **Cicero 216 across 38 works**, bank **376**. **THE TOPICA MOJIBAKE WAS MAPPED SECTION BY SECTION FIRST**, as the reference sheet said it would have to be: **17 of 100 sections are damaged** (6, 12, 24, 30, 31, 35, 38, 42, 45, 48, 49, 55, 56, 79, 83, 93, 95), each because it carries a Greek term the page cannot set; the clean runs are listed in CHANGELOG and the reference sheet. **Section 26 also opens on *quos eui* for *quos exposui*** - the same dropped-letters corruption as *euissem* in section 2 - so the extract starts after it. No emendations.
- ~~**v1.11.0**~~ DONE 01/09: **CAESAR AND HIRTIUS GO STRUCTURAL, no new excerpts.** Scaffolding for the 109-excerpt campaign planned in `~/.claude/plans/let-s-continue-with-caesar-s-snoopy-peacock.md`. **`apply_batch.js` and `create_works.js` now take `--author=<slug>`** (defaulting to Cicero) - both were hardcoded to `AUTHORS['marcus-tullius-cicero']` and **could not touch Caesar at all**. **12 sources.json entries + 12 pages fetched.** Caesar got `needsSelection` + two groups + ten book-works (Verrines pattern); Hirtius got `needsSelection` + two flat works (Plautus pattern), with **ids deliberately distinct** because sources.json is keyed by work id and shared across authors. **All six launch-era fragments re-extracted verbatim and migrated by citation, tags kept at 1.0.0; THREE WERE WRONG** - BC I.7 capitalised *Nulla* for *nulla*, the DBG VIII praefatio carried an invented `[Praefatio]` marker AND invented `1`/`2` subsection numbers, and BA 1 had dropped the crux `+aptantur+` (now restored and explained in both languages). `verify.js` **217 -> 223, 0 mismatched**. `(De Bello Alexandrino n)` -> `(Bellum Alexandrinum n)`. Old `caesar-excerpts` and `corpus-caesarianum` removed.
- **v1.11.0 CORRECTED A PLANNING ASSUMPTION.** The plan was written believing TLL's Caesar pages carry bare-digit subsections inside each chapter (`[13] 1 In omni Gallia ... 2 Plerique ...`). **They do not** - the raw HTML is `[<a name="13">13</a>]  In omni Gallia`, and a scan of all twelve pages finds **zero**. So the two planned `normalise()` rules were **not written** (the plan's one genuine loosening of the verifier never happened), the planned `subsections: true` flag was **not written**, and the agreed bolded `**1.**` markers have nothing to mark. The only such digits in the app were the invented ones in the Hirtius praefatio, now gone.
- **v1.11.0 FOLLOW-UP (same day): the subsections go in after all, and a markdown bug is fixed.** The user asked for the bold arabic subsection markers regardless of the source not printing them - so **the app supplies them**, exactly as it supplies the `[n]` chapter markers. All six fragments marked: BG VI.13 (12), VI.14 (6), BC I.7 (8), the Gallic War VIII preface (7), BA 1 and 2 (5 each). **Three new tools**: `fetch_sections.js` (Perseus CTS `phi0448` - word-exact boundaries, covers the Bellum Gallicum incl. the preface as `8.0`, and the Bellum Civile), `fetch_sections_phi.js` (PHI/Packard author 428, the only source found for the **Bellum Alexandrinum**, which Perseus does not carry - PHI marks the LINE not the word, so those anchors are hand-written and recorded), and `mark_sections.js`, which matches on a folded word stream using **the shortest anchor prefix that occurs exactly once** and treats a zero or ambiguous match as a hard error. **`normalise()` now strips `**n.**`** - the plan's rule A, zero-risk; **223/0 before and after**. Rule B stays unwritten. Citation restored to `(De Bello Gallico VIII, Praefatio 1-7)`, now that the range is checkable.
- **THE BOLD-CONTAINING-ITALIC MARKDOWN BUG HAS SHIPPED TWICE, SO IT IS NOW LINTED.** The user reported `***De Bello Gallico*, Book VIII**` rendering as literal asterisks on Hirtius's page; a sweep found **four** such lines, two of them Italian ones that rendered far worse (`**Il *De Bello Gallico***` -> `*<em>Il </em>De Bello Gallico***`). All fixed. **New `tools/lint_markdown.js` runs in every release** alongside `verify.js` and `lint_translations.js`: it renders every emphasis-bearing line of the drafts, `js/content*.js`, the bank and the What's New exactly as `js/markdown.js` does and fails if an asterisk survives. **1990 lines checked, 0 leaking.**
- **v1.11.0 FOLLOW-UP 2 (same day): the subsection numbers run through the TRANSLATIONS too.** The user asked for it so that a translation error is easy to locate. English and Italian now carry the same `**n.**` markers at the same boundaries - **43 marked sections x 3 texts**, machine-checked to carry the same numbers in the same order. **`mark_sections.js` takes `english` and `italian` anchor arrays**; its folding is language-aware (NFD diacritic strip for the modern languages, u/j fold Latin-only) and it rejects an anchor list of the wrong length. **Translation anchors MUST be written by hand** - a numbered edition can say where the Latin turns a corner, not where a translation turns it - so **every future batch needs a `marks` spec with all three texts** (`batch/marks1111.json` is the worked example). Re-running a spec is safe: an already-marked field is skipped. **Also fixed:** the two Bellum Alexandrinum translations were printing `[1]`/`[2]` at the front where the other four were not (launch-era hand-typing); removed, since the citation already names the chapter.
- ~~**v1.11.2**~~ DONE 01/09: **THE FIRST DE BELLO GALLICO CONTENT BATCH - Book I (6) + Book II (4).** Bank **376 -> 386**, `verify.js` **223 -> 233, 0 mismatched** (a rise of exactly ten), Caesar **3 -> 13**. Book I covers the whole of 58 BC: **I.1** the proem (cut at section 4; 5-7 are a river survey), **I.13** Divico's embassy (the *oratio obliqua* showpiece), **I.29** the Helvetian tablets (368,000 out, 110,000 back, no comment), **I.39** the panic at Vesontio and *Vulgo totis castris testamenta obsignabantur*, **I.40 sections 10-15 only** (the answer to it, ending on the Tenth as *praetoria cohors*), **I.53** the rout and Procillus saved from the three lots. Book II is the Belgic campaign: **II.1** four ranked causes of revolt, **II.20-21** *Caesari omnia uno tempore erant agenda* (seven gerundives in asyndeton), **II.25** the shield taken from the rear rank in one suspended 130-word sentence, **II.27-28** the Nervii on a mound of their own dead, then 600 senators reduced to 3. **One emendation**: TLL prints *de quarta, vigilia* at I.40 with a stray comma; emended to *de quarta vigilia*, recorded on the fragment, noted in the analysis in both languages.
- **THE CHAPTER MARKER IS BACK AT THE HEAD OF THE TRANSLATIONS** (user's call, v1.11.2), for the new ten and the existing six. It had been dropped a few hours earlier on the grounds that the citation already names the chapter; with the subsection numbers running through all three texts, the chapter number is what makes them line up at a glance. **The Gallic War VIII preface is the one exception and correctly so** - the source prints no chapter number there, so neither does the Latin. **Every future batch: chapter marker + subsection markers in Latin, English AND Italian.**
- **`mark_sections.js` grew `sectionFiles`** for an excerpt that runs across a chapter boundary (`II.20-21`, `II.27-28`): the subsection count restarts at 1 after the inner chapter marker, which is how editions cite it, and the monotonic check still holds because it compares positions and not numbers. **`range` is now load-bearing** - three of the ten cover only part of a chapter and each has to declare it, because an unmatched anchor is a hard error.
- ~~**v1.11.1**~~ DONE 01/09: **THE ITALIAN PORTRAIT CAPTIONS, one regex.** The fault the markdown linter turned up at v1.11.0 and left unfixed, now fixed. `js/data.js` `cleanBody` now matches `\((?:imaginary reconstruction|ricostruzione immaginaria)\)` instead of the English wording alone, so the Italian caption is filtered out with the English one. **Four caption lines across two entries, Italian only** - `marcus-pacuvius-and-lucius-accius` and `pomponius-bononiensis-and-quintus-novius`, two each. These are **the only two paired-author entries in the app** and the only ones with two portraits; on every single-portrait entry the caption line sits directly under its image line and was already going out with it, which is why the bug only ever showed on these two. **No Latin touched: `verify.js` 223/0, unchanged**; `lint_translations.js` 344/3; `lint_markdown.js` 2002/0. Verified in the browser by walking every string field of every author of every available era in both languages (`LatinData.getEra` -> intro + authors): **0 hits** for either caption wording or a surviving `![`, against four hits in Italian before the fix. Cache-bust `?v=120` -> `?v=121`.
- **The caption filter is line-based, so the rule for future eras is: a portrait caption must sit on its own line, and must be worded `(imaginary reconstruction)` in English and `(ricostruzione immaginaria)` in Italian.** Any third wording will render as loose asterisks again. `tools/lint_markdown.js` already knows both wordings (it skips caption lines when checking for leaked asterisks); `js/data.js` now agrees with it.
- ~~**v1.11.2 FOLLOW-UP**~~ DONE 01/09 (same release, NOT a new version): **PROOFREADING PASS, no new excerpts** (bank 386, verify 233/0, version tags untouched at 1.11.2). **(1) I.39's translations opened on a bare `he`** with no antecedent in the excerpt - the Ad Brutum I.15 fault - so they now name Caesar. **The reported alternative was checked and rejected**: the suggestion was that the subject might be the army, which would make it `it`. It is not - *moratur* is third person SINGULAR, subject Caesar, carried over from the end of ch. 38 (*Huc Caesar... contendit*), and the army arrives later in the accusative as *omnem exercitum*, object of *occupavit*. A paragraph in the analysis now sets that out. **(2) II.25 gained two paragraphs** on the general and the army: no reserve arrives (section 1 says there was none), only Caesar does, and the charge slows - *in conspectu imperatoris* read against the Tenth of I.40 as *virtus* performed before witnesses. **(3) II.27-28 gained four**: courage on both sides, with the asymmetry that Roman valour is switched on by an arrival while Gallic valour simply is; and then the Gallic War as mass killing - *prope ad internecionem*, over 99% of the Nervii's fighting men, Plutarch's million dead and million enslaved - with the real subject being **the framing**, which is the most successful in Latin prose: Caesar never announces a decision to conquer, every war arrives as a response, and the killing is always somebody else's fault. Cato moved to hand him to the Germans and lost; the Senate voted a 15-day *supplicatio* at the end of this very book.
- ~~**v1.11.3**~~ DONE 01/09: **THE SECOND DE BELLO GALLICO BATCH - Book III (3), Book IV (5), Book VI top-up (2).** Bank **386 -> 396**, `verify.js` **233 -> 243, 0 mismatched**, Caesar **13 -> 23**. **Book III** is the Veneti war as one arc: **III.13** the enemy ships plank by plank (a nautical glossary, and a plain admission the Roman fleet was outclassed), **III.14** the battle won with a *falx muralis* on a pole and fought *in conspectu Caesaris atque omnis exercitus* (the II.25 claim again, with the seating arranged), **III.16** the reprisal - *omni senatu necato reliquos sub corona vendidit* - read against II.28 as the same instrument at its other setting. **Book IV**: **IV.5** the Gauls who stop travellers for news, **IV.14-15** the Usipetes and Tencteri (430,000 against not one Roman dead; Cato's motion), **IV.17** the Rhine bridge (the hardest Latin in the batch; built because boats were *neque suae neque populi Romani dignitatis*), **IV.25** the eagle-bearer of the Tenth - **the only direct speech in the batch** - **IV.33** the British chariot. **Book VI +2**: **VI.16** the wicker figures, **VI.21** the Germans defined by subtraction (*interpretatio Romana* flagged). **One emendation**: TLL prints *decrevat* for *decreverat* at IV.17. **One `fix`**: IV.25's spaced opening quotes, which `normalise()` already cancels.
- **v1.11.3 FOLLOW-UP (same release, NOT a new version): citations, *tela*, and eight analysis notes.** **(1) A citation must name its subsections whenever the excerpt does not cover the whole chapter** - three do not, and are now `I.1.1-4`, `I.40.10-15`, `I.53.1-7`; every other Caesar excerpt was audited against the cached section counts and runs section 1 to last. **`firstSection` needed a new rule for the three-part form or Book I would have sorted 1, 53, 40, 13, 29, 39** (the book-aware rule cannot match three numeric parts, so it fell through to plain digits). The new rule keys on the chapter and **is guarded by a comma test**, because an externally-sourced fragment citation ends in the same shape (`(Odusia, in Gellius, Noctes Atticae III.16.11)`); proved by keying every work old vs new - **91 of 92 identical, the one difference is the fix**. **(2) *tela* is now `projectiles`, not `missiles`** (IV.33 plus II.25, III.13, III.14). **(3) Eight analysis notes**: III.13 the stronger-enemy trade; III.14 the hook as *deus ex machina*; IV.5 if they cannot govern themselves someone must (paired with VI.16); IV.14-15 the freed leaders as calculated *clementia*; IV.17 Roman engineering + the one first-person verb *commemoravi*; IV.25 the Tenth as Caesar's only admitted favourite; IV.33 how little else survives about these peoples (with Tacitus's *Germania*); VI.21 the *Germania* as anticipation. **(4) CORRECTED**: the VI.16 Forum Boarium claim implied Romans were inured to human sacrifice. They were not - they found it abhorrent, and **the Senate outlawed it in 97 BC**, forty years before this was written, which makes the passage a sharper justification, not a blunter one.
- **Books I, II, III and IV are CLOSED at allocation.** Remaining Gallic War: **Book V (7)**, **Book VI (+2)**, **Book VII (9)** = 18 across two more releases.
- ~~**v1.11.4**~~ DONE 03/09: **THE THIRD DE BELLO GALLICO BATCH - Book V (7) + the last 2 of Book VI.** Bank **396 -> 405**, `verify.js` **243 -> 252, 0 mismatched**, Caesar **23 -> 32**. **Book V**: **V.7** Dumnorix killed shouting *liberum se liberaeque esse civitatis* (the only time a Gaul states the case against Rome; the order is conditional, so Caesar never orders a killing) · **V.14** Britain, woad and shared wives (*Vxores* with capital V kept verbatim - the Roman alphabet had no U) · **V.27** Ambiorix, **11 sections of unbroken oratio obliqua**, the hardest Latin so far · **V.30** the Sabinus/Cotta quarrel and *et id clariore voce, ut magna pars militum exaudiret* · **V.37** fifteen cohorts destroyed, Sabinus killed under a truce spun out *consulto*, Cotta *pugnans interficitur*, Petrosidius throwing the eagle back inside the rampart (read against IV.25) · **V.44** Pullo and Vorenus in twenty clauses of historic present · **V.48** the letter in Greek characters on a javelin. **Book VI +2**: **VI.11** the factions, whose last sentence explains the conquest · **VI.28** the aurochs, the only chapter in seven books with no Roman in it. **Two emendations**: TLL drops a word at V.27 (*apud in servitute*) and splits one at VI.11 (*contra potentio rem*). **One `fix`**: V.44's spaced quote and question mark.
- **VI.13 AND VI.14 EXTENDED** (the user asked): the two launch-era druid excerpts had two purely grammatical paragraphs each and now have four more between them, on the history - these two chapters are nearly the whole ancient record of the druids; Caesar's Gaul reproduces the Roman constitution (priesthood, knights, commons, and no kings or craftsmen), which should be held lightly; the Carnutes assembly sits oddly against the divided Gaul of VI.11; the refusal to write is why no druidic literature exists; the Vedic parallel; why *volunt persuadere* does not quite license the Pythagoras comparison; and **Diviciacus the Aeduan, Caesar's closest Gallic ally, was a druid** - attested by Cicero at *De Divinatione* I.90, which is already in the app. **Version tags left at 1.0.0.**
- **`mark_sections.js` gained `overrides`** (section number -> replacement anchor) for the case the shortest-prefix rule cannot rescue: the edition and TLL differ on a section's FIRST words. V.7.3 is the example, Perseus *quod Carus ventus* against TLL *quod Corus ventus*, both real spellings. **Respell the anchor, do not emend the text** - a variant is not an error.
- **v1.11.4 FOLLOW-UP (same release, NOT a new version): the user's proofreading pass.** No new excerpts; bank 405, verify 252/0, version tags untouched. **CONTEXT ADDED** where Book V assumes knowledge the reader has not got: **V.7** who Dumnorix was (Aeduan, *fratres consanguineique populi Romani*, richest man in the state, brother of Diviciacus, already forgiven once) and **why he ran** (Caesar was shipping the Gallic nobility to Britain as hostages in all but name; Dumnorix was one, and bolted) · **V.27** who Ambiorix was (client-king of the Eburones who owed Caesar two personal favours, hence the gratitude opening; the most successful enemy Caesar ever had) **and the Cicero of section 9 is QUINTUS**, the man besieged at V.48 · **V.30** what was being argued - whether to believe Ambiorix, on that speech and nothing else · **VI.11** who the Aedui were. **CONTRADICTION FIXED**: V.27's description said almost nothing in the speech was true, its analysis said everything was; both now say the checkable claims were true and that is what buys belief for the two inventions. **VI.28**: *Hos studiose foveis captos interficiunt* had drifted into section 3 in both translations, back in 2. **V.14 now prints *Uxores* not *Vxores*** (the ancient V-for-U convention reads as a typo) as a **declared emendation**, so verify still checks it against the source.
- **ITALIAN GRAMMAR FIX, worth remembering:** *perche apparisse aver usato misericordia* -> ***affinche apparisse DI aver usato misericordia***. The clause is final, so *affinche* removes the causal reading, and the *di* is required after *apparire*. Fixed in II.27-28's translation and in the three analyses quoting it (II.27-28, III.16, IV.14-15) - **and the identical fault was found and fixed in `(In Catilinam IV.19)`** while sweeping for it.
- **A CLAIM WITHDRAWN: `De Divinatione` I.90 is NOT in the app.** VI.14's analysis said it was. The Cicero reference stands (it is the one place a named druid - Diviciacus - is described by someone who met him), but the claim about the app is gone. **Kept as a candidate excerpt if De Divinatione is ever extended.**
- **NOTES ADDED**: V.37 the arranged irony (Sabinus's loud accountability speech at V.30 against his death mid-parley, Cotta fighting, Petrosidius - who holds no command - behaving best), the silence about who dispersed the legions, and the 53 BC erasure of the Eburones with neighbouring peoples invited in to do the plundering · V.48 the besiegers ARE the Nervii spared at II.28, so the *clementia* of Book II has a bill · VI.11 *Gallia est omnis divisa in partes tres* (a division Caesar performs) against *omnes civitates in partes divisae sunt duas* (one the Gauls already made), and *divide et impera* with the first half done for him.
- ~~**v1.11.5**~~ DONE 03/09: **BOOK VII - AND THE GALLIC WAR IS FINISHED.** Bank **405 -> 414**, `verify.js` **252 -> 261, 0 mismatched**, Caesar **32 -> 41**. **All seven books closed at their allocated 40.** **VII.3** Cenabum and the shouting relay (160 miles between sunrise and the first watch; read against IV.5) · **VII.4** Vercingetorix, the only extended portrait of an enemy commander (father killed *quod regnum appetebat*, then *rex ab suis appellatur* - the oldest Roman nightmare, and Caesar would be accused of it within three years) · **VII.14** the scorched-earth council, the best strategy in the seven books and it belongs to the enemy · **VII.15** twenty towns in a day and the one argument Vercingetorix loses · **VII.28** *nec fuit quisquam, qui praedae studeret*, 40,000 to 800, and the last section handed to Vercingetorix · **VII.52** the assembly after Gergovia (blame on the troops, the plan never mentioned - the V.37 silence again) · **VII.73** the Alesia traps and the soldiers' nicknames *cippi/lilia/stimuli* · **VII.77.12-16** Critognatus, **the only enemy speech in direct discourse in the whole work**, framed by Caesar as *singularem et nefariam crudelitatem* so that the finest anti-imperial argument in Latin arrives disqualified · **VII.89** the surrender in four clauses and two agentless passives.
- **THREE SOURCE FAULTS in `gall7`**: **VII.52.2 prints `Euit` for `Exposuit`** (the head of the verb dropped), and **VII.3.1 / VII.28.2 print `Vbi`** - all three emended and recorded, the last two following the `Vxores` -> `Uxores` precedent. **`mark_sections.js` needed three `overrides`**: two for the Vbi/Ubi respelling, and one worth remembering for a different reason - **Perseus divides `Qua re` at VII.73.2 where TLL writes `Quare`**, and since the matcher works on whole words a word-division difference defeats it exactly as a variant reading would.
- **VII.77 is the only partial chapter in the batch**, cited `VII.77.12-16`. It begins mid-speech, so it ends on a closing quotation mark whose partner is nine sections earlier; the analysis explains it rather than the text being altered.
- **NEXT: the plan is written out release by release in
  ...
  **v1.9.0** = De Officiis 5 + De Re Publica 4 + Somnium Scipionis 4; v1.9.1 = Tusculanae 5;
  ...
  at 23 across 5**). Then **Caesar, Hirtius, Lucretius, Sallust, Catullus**. **THE WHOLE PLAN IS SHIPPED. CICERO IS COMPLETE AND CLOSED** - 216 across 38 works,
  Speeches 116, Letters 26, Philosophical 48, Rhetorical 26. The user has said he is to be left
  alone for a good while. **The next thing in this app is
  the rest of Caesar's Age: Caesar, Hirtius, Lucretius, Sallust, Catullus** - all five already
  have entries and a handful of excerpts each. Two questions stay open and are the user's call:
  whether the Tusculans grow past 5 (if so, restore the benched Archimedes tomb V.64-66 first),
  and whether any rhetorical work grows past its current size. The one philosophical question still open is whether the Tusculans grow past 5, in
  which case the benched Archimedes tomb (V.64-66) is the first thing to restore. `de-amicitia` was mapped in v1.8.3 and all eight of its fragments now verify. Rhetorical is still empty - its five works are
