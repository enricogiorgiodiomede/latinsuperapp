...
| **Gaius Julius Caesar** *(needsSelection, NESTED chooser, v1.11.0)* | Good Exercise | **Two groups, ten book-works**: `bellum-gallicum` = `bg-i`..`bg-vii`, `bellum-civile` = `bc-i`..`bc-iii`, all mapped in sources.json. Filled so far: **Book I 6** (1, 13, 29, 39, 40.10-15, 53) · **Book II 4** (1, 20-21, 25, 27-28) · **Book III 3** (13, 14, 16) · **Book IV 5** (5, 14-15, 17, 25, 33) · **Book VI 4** (13, 14, 16, 21) · **BC I 1** (7) = **23**. Books I, II, III and IV are CLOSED at allocation; VI still owes 2. Empty books are hidden by `PracticeBank.works()` until filled. |
