...
| **Gaius Julius Caesar** *(needsSelection, NESTED chooser, v1.11.0)* | Good Exercise | **Two groups, ten book-works**: `bellum-gallicum` = `bg-i`..`bg-vii`, `bellum-civile` = `bc-i`..`bc-iii`, all mapped in sources.json. Filled so far: **Book I 6** (1, 13, 29, 39, 40.10-15, 53) · **Book II 4** (1, 20-21, 25, 27-28) · **Book III 3** (13, 14, 16) · **Book IV 5** (5, 14-15, 17, 25, 33) · **Book V 7** (7, 14, 27, 30, 37, 44, 48) · **Book VI 6** (11, 13, 14, 16, 21, 28) · **BC I 1** (7) = **32**. **Books I-VI are ALL CLOSED at allocation**; only Book VII (9) is left to finish the Gallic War. Empty books are hidden by `PracticeBank.works()` until filled. |
